class PharmacyFinder::Store
	...
	def self.scrape_riteaid
		doc = Nokogiri::HTML(open("https://locations.riteaid.com/locations/search.html?q=#{PharmacyFinder::CLI.zipcode}"))
		# binding.pry
		riteaid = self.new
...
### If both are enabled at the same time, the app hangs on the scraping and never finishes.
